...
\begin{abstract}
Four results left open in the main paper series are closed here.
(i)~The Wolfenstein parameter $A$ and the CKM element $|V_{cb}|$
are derived from the channel weights: $|V_{cb}| = W_B \times W_M
= 2r^3(1-r) = 0.04079$ (PDG $0.04113$, $-0.85\%$,
$0.14\,n\,\varepsilon_{\text{floor}}$, $n = 2$) and
$A = W_B W_M \varphi^6 = 0.7318$ (PDG $0.7380$, $-0.85\%$,
...
bringing the framework to $\mathbf{21/21}$ within
...
The axiom $c^2 = c + 1$ and its consequences (Paper~1):
\begin{equation}
...
\textbf{21 observables. Zero free parameters. 21/21 within
$2\,n\,\varepsilon_{\text{floor}}$.}

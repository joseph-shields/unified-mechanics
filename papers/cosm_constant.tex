...
$\varphi^2 = \varphi + 1$.  The dominant contribution to the cosmological
...
Normalised by the accumulated braiding floor at depth $n = 241$:
\[
  n\,\varepsilon_{\text{floor}} = 241 \times r^3 \approx 711\%,
  \qquad
  \frac{5.5\%}{711\%} = 0.008\,n\,\varepsilon_{\text{floor}}.
\]
This is the most precisely satisfied prediction in the UM corpus.

...
\begin{equation}
  ...
  = +8.2\%
  = 2.77\,\varepsilon_{\text{floor}}.
  \label{eq:eta_resid}
\end{equation}

The result is within $3\,\varepsilon_{\text{floor}}$ of the
observed value. For comparison, neighbouring powers of $r$:
...
determined by the recursion. The $8.2\%$ residual is within three
braiding floors, consistent with a next-order correction from thermal
physics.
